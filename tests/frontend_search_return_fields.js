...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "mocha", "../lib/boxalino/example/frontend_search_return_fields"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    require("mocha");
    const _frontendSearchReturnFields = require("../lib/boxalino/example/frontend_search_return_fields");
    describe("frontend_search_return_fields", () => {
        ...
        it("test", () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield _frontendSearch.frontendSearchReturnFields(account, password, isDev, bxHost, queryText);
        })).timeout(5000);
    });
});
