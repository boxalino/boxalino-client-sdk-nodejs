...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "mocha", "../lib/boxalino/example/frontend_search_autocomplete_property"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    require("mocha");
    const _frontendSearchAutocompleteItems = require("../lib/boxalino/example/frontend_search_autocomplete_property");
    describe("frontend_search_autocomplete_property", () => {
        ...
        it("test", () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield _frontendSearch.frontendSearchAutocompleteProperty(account, password, isDev, bxHost, queryText);
        })).timeout(5000);
    });
});
