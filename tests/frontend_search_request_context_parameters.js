...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "mocha", "../lib/boxalino/example/frontend_search_request_context_parameters"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    require("mocha");
    const _frontendSearchRequestContextParameters = require("../lib/boxalino/example/frontend_search_request_context_parameters");
    describe("frontend_search_request_context_parameters", () => {
        ...
        it("test", () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield _frontendSearch.frontendSearchRequestContextParameter(account, password, isDev, bxHost, queryText);
        })).timeout(5000);
    });
});
