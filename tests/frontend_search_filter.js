...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "mocha", "assert", "../lib/boxalino/example/frontend_search_filter"], factory);
    }
    ...
    describe("frontend_search_filter", () => {
        ...
        it("test", () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield _frontendSearch.frontendSearchFilter(account, password, isDev, bxHost, queryText);
