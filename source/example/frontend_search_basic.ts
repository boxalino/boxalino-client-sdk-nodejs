...
export class frontend_search_basic {
    ...
    public async frontendSearchBasic(account: string, password: string, isDev: boolean, host: string, queryText: string) {
        ...
        try {
            ...
            logs.push("Results for query \"" + queryText + "\" (" + this.bxResponse.getTotalHitCount().toString() + "):");
