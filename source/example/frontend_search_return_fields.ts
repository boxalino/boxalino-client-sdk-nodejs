...
export class frontend_search_return_fields {
    ...
    public async frontendSearchReturnFields(account: string, password: string, isDev: boolean, host: string, queryText: string) {
