...
export class frontend_recommendations_basket {
    ...
    public async frontend_recommendations_basket(account: string, password: string, isDev: boolean, host: string) {
        ...
        try {
            ...
            let fields: string[] = ["discountedPrice", "id", "title"];
