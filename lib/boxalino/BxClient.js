...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./BxRecommendationRequest", "./BxChooseResponse", "./BxAutocompleteResponse"], factory);
    }
    ...
    var BxAutocompleteResponse_1 = require("./BxAutocompleteResponse");
    var BxClient = /** @class */ (function () {
        function BxClient(account, password, domain, isDev, host, request, apiKey, apiSecret) {
            if (isDev === void 0) { isDev = false; }
            if (host === void 0) { host = "main.bx-cloud.com"; }
        ...
        BxClient.prototype.getP13n = function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.getP13n().chooseAll(choiceRequestBundle)];
                        case 1:
        ...
        BxClient.prototype.p13nautocomplete = function (autocompleteRequest) {
            try {
                var choiceResponse = this.getP13n().autocomplete(autocompleteRequest);
                if ((typeof (this.requestMap['dev_bx_disp']) != "undefined" && this.requestMap['dev_bx_disp'] !== null) && this.requestMap['dev_bx_disp'] == 'true') {
        ...
        BxClient.prototype.autocomplete = function () {
            return __awaiter(this, void 0, void 0, function () {
                var spval, profileid, userRecord, tempArray, p13nrequests, i, tempArrayBxAuto, thisRefObj;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            p13nrequests = tempArray.map(function (tempItem) {
                        ...
                        case 1:
                            ...
                            thisRefObj = this;
                            this.autocompleteResponses = tempArrayBxAuto.map(function (thisObj) {
        ...
        BxClient.prototype.getAutocompleteResponse = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getAutocompleteResponses()];
                        case 1:
                            responses = _a.sent();
        ...
        BxClient.prototype.p13nautocompleteAll = function (requests) {
            return __awaiter(this, void 0, void 0, function () {
                var requestBundle, choiceResponse, tmp, e_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            choiceResponse = null;
                            return [4 /*yield*/, this.getP13n().autocompleteAll(requestBundle)];
                        case 2:
                            tmp = _a.sent();
        ...
        BxClient.prototype.getAutocompleteResponses = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!!this.autocompleteResponses) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.autocomplete()];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [2 /*return*/, this.autocompleteResponses];
                    }
                });
            });
        };
        ...
        BxClient.prototype.autocompletePartail = function (response, i) {
            var request = this.autocompleteRequests[i];
            var bxAutoCompleteResponse = new BxAutocompleteResponse_1.BxAutocompleteResponse(response, request);
