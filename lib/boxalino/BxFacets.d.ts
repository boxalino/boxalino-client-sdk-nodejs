export declare class BxFacets {
    ...
    protected getFacetValueArray(fieldName: string, facetValue: string): any;
    getCategoryValueLabel(facetValue: any): any;
    getSelectedPriceRange(): any;
    getPriceValueLabel(facetValue: string): any;
    getFacetValueLabel(fieldName: string, facetValue: string): any;
    getCategoryValueCount(facetValue: string): any;
    getPriceValueCount(facetValue: string): any;
    getFacetValueCount(fieldName: string, facetValue: string): any;
    isFacetValueHidden(fieldName: string, facetValue: string): any;
    getCategoryValueId(facetValue: string): any;
    getPriceValueParameterValue(facetValue: string): any;
    getFacetValueParameterValue(fieldName: string, facetValue: string): any;
    isPriceValueSelected(facetValue: string): any;
    isFacetValueSelected(fieldName: string, facetValue: string): any;
    getFacetValueIcon(fieldName: string, facetValue: string, language?: any, defaultValue?: string): string;
    getThriftFacets(): any;
