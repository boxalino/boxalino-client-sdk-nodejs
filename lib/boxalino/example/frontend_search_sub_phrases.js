...
(function (factory) {
    ...
    var frontend_search_sub_phrases = /** @class */ (function () {
        function frontend_search_sub_phrases() {
        ...
        frontend_search_sub_phrases.prototype.frontendSearchSubPhrases = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, hitCount, bxRequest, _a, logs, subPhrasesQuery, i, subPhrase, subPhrasesHitIds, j, subPhraseHitId, i, id, e_1, exception;
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            if (this.bxResponse.areThereSubPhrases()) {
                                ...
                                subPhrasesQuery = this.bxResponse.getSubPhrasesQueries();
                                if (subPhrasesQuery != null) {
                                    for (i in subPhrasesQuery) {
                                        subPhrase = subPhrasesQuery[i];
                                        logs.push("Results for \"" + subPhrase + "\" (" + this.bxResponse.getSubPhraseTotalHitCount(subPhrase).toString() + " hits):");
                                        subPhrasesHitIds = this.bxResponse.getSubPhraseHitIds(subPhrase);
                                        if (subPhrasesHitIds != null) {
                                            for (j in subPhrasesHitIds) {
                                                subPhraseHitId = subPhrasesHitIds[j];
        ...
        return frontend_search_sub_phrases;
    }());
    exports.frontend_search_sub_phrases = frontend_search_sub_phrases;
});
