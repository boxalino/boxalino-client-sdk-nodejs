...
(function (factory) {
    ...
    var frontend_search_debug_request = /** @class */ (function () {
        function frontend_search_debug_request() {
        ...
        frontend_search_debug_request.prototype.frontendSearchDebugRequest = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var language, hitCount, logs, bxRequest, _a, e_1, exception;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            _a = this;
                            return [4 /*yield*/, this.bxClient.getResponse()];
                        case 2:
                            //make the query to Boxalino server and get back the response for all requests
        ...
        return frontend_search_debug_request;
    }());
    exports.frontend_search_debug_request = frontend_search_debug_request;
});
