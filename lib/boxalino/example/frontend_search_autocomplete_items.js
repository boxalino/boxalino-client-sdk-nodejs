    ...
    var frontend_search_autocomplete_items = /** @class */ (function () {
        ...
        frontend_search_autocomplete_items.prototype.frontendSearchAutocompleteItems = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, textualSuggestionsHitCount, fieldNames, thisObj, bxRequest, _a, suggestion, hitFieldValues, hitFieldValues1, e_1, exception;
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            for (suggestion in this.bxResponse.getTextualSuggestions()) {
                                ...
                                hitFieldValues = this.bxResponse.getBxSearchResponse(suggestion).getHitFieldValues(fieldNames);
                                hitFieldValues.forEach(function (fieldValueMap, id) {
                            ...
                            hitFieldValues1 = this.bxResponse.getBxSearchResponse().getHitFieldValues(fieldNames);
                            hitFieldValues1.forEach(function (id, fieldValueMap) {
                                var item = id;
                                for (var fieldName in fieldValueMap) {
                                    //thisObj.logs.push(" - "+fieldName+": " + fieldValueMap[fieldName].toString());
