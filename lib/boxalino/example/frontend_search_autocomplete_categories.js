...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../BxClient", "../BxAutocompleteRequest", "../BxFacets"], factory);
    }
    ...
    var frontend_search_autocomplete_categories = /** @class */ (function () {
        function frontend_search_autocomplete_categories() {
        ...
        frontend_search_autocomplete_categories.prototype.frontend_search_autocomplete_categories = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, textualSuggestionsHitCount, bxRequest, bxSearchRequest, facets, _a, logs, suggestion, i, suggestion, value, e_1, exception;
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            for (suggestion in this.bxResponse.getTextualSuggestions()) {
                                logs.push(this.bxResponse.getTextualSuggestionHighlighted(suggestion));
                                if (i == 0) {
                                    for (value in this.bxResponse.getTextualSuggestionFacets(suggestion)) {
        ...
        return frontend_search_autocomplete_categories;
    }());
    exports.frontend_search_autocomplete_categories = frontend_search_autocomplete_categories;
});
//# sourceMappingURL=frontend_search_autocomplete_categories.js.map