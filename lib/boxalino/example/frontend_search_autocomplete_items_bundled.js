                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            this.bxResponses.forEach(function (bxAutocompleteResponse) {
                                ...
                                bxAutocompleteResponse.getTextualSuggestions().forEach(function (suggestion) {
                                    ...
                                    //loop on the search response hit ids and print them
                                    bxAutocompleteResponse.getBxSearchResponse(suggestion).getHitFieldValues(fieldNames).forEach(function (id, fieldValueMap) {
                                ...
                                //loop on the search response hit ids and print them
                                bxAutocompleteResponse.getBxSearchResponse().getHitFieldValues(fieldNames).forEach(function (id, fieldValueMap) {
                                    thisObj.logs.push("<div>" + id);
                                    fieldValueMap.forEach(function (fieldName, fieldValues) {
                                        thisObj.logs.push(" - " + fieldName + ": " + fieldValues.join(','));
                                    });
