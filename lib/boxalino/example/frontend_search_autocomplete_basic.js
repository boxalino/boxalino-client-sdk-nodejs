...
(function (factory) {
    ...
    var frontend_search_autocomplete_basic = /** @class */ (function () {
        function frontend_search_autocomplete_basic() {
        ...
        frontend_search_autocomplete_basic.prototype.frontendSearchAutocompleteBasic = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, hitCount, bxRequest, _a, logs, suggestion, e_1, exception;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            language = "en";
                            hitCount = 10;
                            bxRequest = new bxAutoCompleteRequest.BxAutocompleteRequest(language, queryText, hitCount);
                            //set the request
                            _bxClient.setAutocompleteRequest(bxRequest);
        ...
        return frontend_search_autocomplete_basic;
    }());
    exports.frontend_search_autocomplete_basic = frontend_search_autocomplete_basic;
});
