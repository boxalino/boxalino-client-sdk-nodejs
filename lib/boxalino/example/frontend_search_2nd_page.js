...
(function (factory) {
    ...
    var frontend_search_2nd_page = /** @class */ (function () {
        function frontend_search_2nd_page() {
        ...
        frontend_search_2nd_page.prototype.frontendSearch2ndPage = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, hitCount, offset, bxRequest, _a, logs, GetHitIds, i, ID, i, id, e_1, exception;
                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            if (this.bxResponse.getHitIds()) {
                                GetHitIds = this.bxResponse.getHitIds();
                                if (GetHitIds != null) {
                                    for (i in GetHitIds) {
                                        ID = GetHitIds[i];
        ...
        return frontend_search_2nd_page;
    }());
    exports.frontend_search_2nd_page = frontend_search_2nd_page;
});
