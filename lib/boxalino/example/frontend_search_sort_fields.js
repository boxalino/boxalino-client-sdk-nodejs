...
(function (factory) {
    ...
    var frontend_search_sort_fields = /** @class */ (function () {
        function frontend_search_sort_fields() {
        ...
        frontend_search_sort_fields.prototype.frontendSearchSortFields = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, hitCount, sortField, sortDesc, bxRequest, _a, logs, entity, hitFieldValues, i, hitFields, j, hitValues, e_1, exception;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            logs = Array();
                            entity = "";
                            hitFieldValues = this.bxResponse.getHitFieldValues([sortField]);
        ...
        return frontend_search_sort_fields;
    }());
    exports.frontend_search_sort_fields = frontend_search_sort_fields;
});
//# sourceMappingURL=frontend_search_sort_fields.js.map