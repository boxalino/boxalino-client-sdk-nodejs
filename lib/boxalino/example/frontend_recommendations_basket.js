...
(function (factory) {
    ...
    var frontend_recommendations_basket = /** @class */ (function () {
        function frontend_recommendations_basket() {
        ...
        frontend_recommendations_basket.prototype.frontend_recommendations_basket = function (account, password, isDev, host) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, choiceId, itemFieldId, itemFieldIdValue, hitCount, fields, bxRequest, _a, logs, i, id, e_1, exception;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            bxRequest.setBasketProductWithPrices(itemFieldId, itemFieldIdValue);
                            //add the request
        ...
        return frontend_recommendations_basket;
    }());
    exports.frontend_recommendations_basket = frontend_recommendations_basket;
});
