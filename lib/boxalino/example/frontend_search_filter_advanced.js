...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../BxClient", "../BxSearchRequest", "../BxFilter"], factory);
    }
    ...
    var bxFilter = require("../BxFilter");
    var request = require('request');
    var frontend_search_filter_advanced = /** @class */ (function () {
        function frontend_search_filter_advanced() {
        ...
        frontend_search_filter_advanced.prototype.frontendSearchFilterAdvanced = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, hitCount, filterField, filterValues, filterNegative, filterField2, filterValues2, filterNegative2, orFilters, fieldNames, bxRequest, _a, logs, hitFieldValues, i, hitFields, j, hitValues, e_1, exception;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            hitCount = 10;
                            filterField = "id";
                            filterValues = ["41", "1941"];
                            filterNegative = true;
                            filterField2 = "products_color";
                            filterValues2 = ["Yellow"];
                            filterNegative2 = false;
                            orFilters = true;
                            fieldNames = ["products_color"];
                        ...
                        case 2:
                            ...
                            logs = Array();
                            hitFieldValues = this.bxResponse.getHitFieldValues(fieldNames);
        ...
        return frontend_search_filter_advanced;
    }());
    exports.frontend_search_filter_advanced = frontend_search_filter_advanced;
});
