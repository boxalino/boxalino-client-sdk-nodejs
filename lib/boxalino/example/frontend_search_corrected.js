...
(function (factory) {
    ...
    var frontend_search_corrected = /** @class */ (function () {
        function frontend_search_corrected() {
        ...
        frontend_search_corrected.prototype.frontendSearchCorrected = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, hitCount, logs, bxRequest, _a, i, id, e_1, exception;
        ...
        return frontend_search_corrected;
    }());
    exports.frontend_search_corrected = frontend_search_corrected;
});
