...
(function (factory) {
    ...
    var frontend_search_autocomplete_property = /** @class */ (function () {
        function frontend_search_autocomplete_property() {
        ...
        frontend_search_autocomplete_property.prototype.frontendSearchAutocompleteProperty = function (account, password, isDev, host, queryText) {
            return __awaiter(this, void 0, void 0, function () {
                var _bxClient, language, textualSuggestionsHitCount, thisObj, property_1, propertyTotalHitCount, propertyEvaluateCounters, bxRequest, _a, e_1, exception;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            bxRequest.addPropertyQuery(property_1, propertyTotalHitCount, true);
                            //set the request
                        ...
                        case 2:
                            ...
                            this.bxResponse.getPropertyHitValues(property_1).forEach(function (hitValue) {
                                var label = thisObj.bxResponse.getPropertyHitValueLabel(property_1, hitValue);
                                var totalHitCount = thisObj.bxResponse.getPropertyHitValueTotalHitCount(property_1, hitValue);
                                var result = "<b>" + hitValue + ":</b><ul><li>label=" + label + "</li> <li>totalHitCount=" + totalHitCount + "</li></ul>";
        ...
        return frontend_search_autocomplete_property;
    }());
    exports.frontend_search_autocomplete_property = frontend_search_autocomplete_property;
});
//# sourceMappingURL=frontend_search_autocomplete_property.js.map