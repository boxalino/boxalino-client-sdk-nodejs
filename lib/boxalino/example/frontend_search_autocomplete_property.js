                    ...
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            this.bxResponse.getPropertyHitValues(property_1).forEach(function (hitValue) {
                                var label = this.bxResponse.getPropertyHitValueLabel(property_1, hitValue);
                                var totalHitCount = this.bxResponse.getPropertyHitValueTotalHitCount(property_1, hitValue);
