...
var URLVariables = require("./index");
function main() {
    var author = {
...
function test_global(author) {
    //----
    // STRINGIFY & PARSE
    //----
    // STRINGIFY -> OBJECT TO URL-ENCODED STRING
    var url_encoded_str = URLVariables.stringify(author);
    console.log(url_encoded_str);
    console.log("----------------------------------\n");
    // PARSE -> URL-ENCODED STRING TO OBJECT
    var obj = URLVariables.parse(url_encoded_str, true);
    //----
    // VALIDATE
    //----
    // VALIDATE STRINGIFY
...
function test_class(author) {
    console.log("\n----------------------------------\n");
    //----
    // GENERATE URL-VARIABLES OBJECT
    //----
    var dict = new URLVariables();
    // FILL ELEMENTS
    ...
    var url_encoded_str = dict.toString();
    //----
    // VALIDATIONS
    //----
    // CREATE A NEW URL-VARIABLES OBJECT 
    // BY PARSING THE URL-ENCODED STRING
    var vars = new URLVariables(url_encoded_str);
    // VALIDATE SIZE
    if (dict.size() != vars.size())
        throw new std.LengthError("Size are different.");
    // ALL ELEMENTS ARE EQUAL
    var equal = std.equal(dict.begin(), dict.end(), vars.begin(), function (x, y) {
