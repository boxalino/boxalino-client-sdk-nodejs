...
import { WebClientDriver } from "../../protocol/communicator/client_driver/WebClientDriver";
/**
 * An user.
 *
 ...
 *	<img src="http://samchon.github.io/framework/images/design/ts_class_diagram/templates_cloud_service.png"
    ...
    */
export declare abstract class User extends collections.HashMapCollection<number, Client> implements IProtocol {
    /**
     * @hidden
     */
    private server_;
