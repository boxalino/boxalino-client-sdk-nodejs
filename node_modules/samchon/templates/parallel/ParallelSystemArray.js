...
var ExternalSystemArray_1 = require("../external/ExternalSystemArray");
 ...
 *		  target="_blank">
    ...
    */
var ParallelSystemArray = /** @class */ (function (_super) {
    ...
    ParallelSystemArray.prototype.sendPieceData = function (invoke, first, last) {
        if (invoke.has("_History_uid") == false)
            invoke.push_back(new InvokeParameter_1.InvokeParameter("_History_uid", ++this.history_sequence_));
        else {
    ...
    ParallelSystemArray.prototype._Complete_history = function (history) {
        // WRONG TYPE
        if ((history instanceof PRInvokeHistory_1.PRInvokeHistory) == false)
            return false;
...
exports.ParallelSystemArray = ParallelSystemArray;
//# sourceMappingURL=ParallelSystemArray.js.map