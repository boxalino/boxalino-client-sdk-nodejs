/// <reference path="../DistributedSystemArray.d.ts" />
 ...
 */
export declare abstract class DistributedServerArray<System extends IDistributedServer> extends DistributedSystemArray<System> implements IExternalServerArray<System> {
    /**
     * Default Constructor.
     */
    constructor();
