 ...
 */
export declare abstract class DistributedClientArrayMediator<System extends DistributedSystem> extends DistributedSystemArrayMediator<System> implements IExternalClientArray<System> {
    /**
