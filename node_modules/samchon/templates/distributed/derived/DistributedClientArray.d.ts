 ...
 */
export declare abstract class DistributedClientArray<System extends DistributedSystem> extends DistributedSystemArray<System> implements IExternalClientArray<System> {
    /**
     * @hidden
     */
