...
import { SharedWorkerClientDriver } from "../communicator/client_driver/SharedWorkerClientDriver";
/**
 ...
 * @copydoc IServer
 */
export declare abstract class SharedWorkerServer implements IServer {
    /**
     * @inheritdoc
     */
