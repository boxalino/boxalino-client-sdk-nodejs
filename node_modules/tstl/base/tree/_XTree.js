...
var _XTree = /** @class */ (function () {
    ...
    _XTree.prototype.insert = function (val) {
        ...
        var node = new _XTreeNode_1._XTreeNode(val, _Color_1._Color.RED);
        if (parent === null)
            this.root_ = node;
        else {
            node.parent = parent;
    ...
    _XTree.prototype._Insert_case1 = function (n) {
        if (n.parent === null)
            n.color = _Color_1._Color.BLACK;
        else
            this._Insert_case2(n);
    };
    _XTree.prototype._Insert_case2 = function (n) {
        if (this._Fetch_color(n.parent) === _Color_1._Color.BLACK)
            return;
        else
            this._Insert_case3(n);
    };
    _XTree.prototype._Insert_case3 = function (n) {
        if (this._Fetch_color(n.uncle) === _Color_1._Color.RED) {
            n.parent.color = _Color_1._Color.BLACK;
            n.uncle.color = _Color_1._Color.BLACK;
            n.grand.color = _Color_1._Color.RED;
    ...
    _XTree.prototype.erase = function (val) {
        ...
        if (this._Fetch_color(node) === _Color_1._Color.BLACK) {
            node.color = this._Fetch_color(child);
            this._Erase_case1(node);
        }
        this._Replace_node(node, child);
        if (this._Fetch_color(this.root_) === _Color_1._Color.RED)
            this.root_.color = _Color_1._Color.BLACK;
    };
    ...
    _XTree.prototype._Erase_case2 = function (n) {
        if (this._Fetch_color(n.sibling) === _Color_1._Color.RED) {
            n.parent.color = _Color_1._Color.RED;
            n.sibling.color = _Color_1._Color.BLACK;
            if (n === n.parent.left)
                this._Rotate_left(n.parent);
            else
                this._Rotate_right(n.parent);
    ...
    _XTree.prototype._Erase_case3 = function (n) {
        if (this._Fetch_color(n.parent) === _Color_1._Color.BLACK &&
            this._Fetch_color(n.sibling) === _Color_1._Color.BLACK &&
            this._Fetch_color(n.sibling.left) === _Color_1._Color.BLACK &&
            this._Fetch_color(n.sibling.right) === _Color_1._Color.BLACK) {
            n.sibling.color = _Color_1._Color.RED;
    ...
    _XTree.prototype._Erase_case4 = function (N) {
        if (this._Fetch_color(N.parent) === _Color_1._Color.RED &&
            N.sibling !== null &&
            this._Fetch_color(N.sibling) === _Color_1._Color.BLACK &&
            this._Fetch_color(N.sibling.left) === _Color_1._Color.BLACK &&
            this._Fetch_color(N.sibling.right) === _Color_1._Color.BLACK) {
    ...
    _XTree.prototype._Erase_case5 = function (n) {
        if (n === n.parent.left &&
            n.sibling !== null &&
            this._Fetch_color(n.sibling) === _Color_1._Color.BLACK &&
            this._Fetch_color(n.sibling.left) === _Color_1._Color.RED &&
            this._Fetch_color(n.sibling.right) === _Color_1._Color.BLACK) {
            n.sibling.color = _Color_1._Color.RED;
            n.sibling.left.color = _Color_1._Color.BLACK;
            ...
            this._Fetch_color(n.sibling) === _Color_1._Color.BLACK &&
            this._Fetch_color(n.sibling.left) === _Color_1._Color.BLACK &&
            this._Fetch_color(n.sibling.right) === _Color_1._Color.RED) {
            n.sibling.color = _Color_1._Color.RED;
            n.sibling.right.color = _Color_1._Color.BLACK;
