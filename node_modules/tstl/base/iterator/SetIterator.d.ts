 ...
 */
export declare class SetIterator<Key, Unique extends boolean, Source extends SetContainer<Key, Unique, Source>> extends ListIterator<Key, Source, SetIterator<Key, Unique, Source>, SetReverseIterator<Key, Unique, Source>> {
    /**
     * @hidden
     */
    private source_;
 ...
 * @author Jeongho Nam <http://samchon.org>
 */
export declare class SetReverseIterator<Key, Unique extends boolean, Source extends SetContainer<Key, Unique, Source>> extends ReverseIterator<Key, Source, SetIterator<Key, Unique, Source>, SetReverseIterator<Key, Unique, Source>> {
    /**
