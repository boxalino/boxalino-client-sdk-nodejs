 ...
 */
export declare class MapIterator<Key, T, Unique extends boolean, Source extends MapContainer<Key, T, Unique, Source>> extends ListIterator<Entry<Key, T>, Source, MapIterator<Key, T, Unique, Source>, MapReverseIterator<Key, T, Unique, Source>> {
    /**
     * @hidden
     */
    private source_;
 ...
 * @author Jeongho Nam <http://samchon.org>
 */
export declare class MapReverseIterator<Key, T, Unique extends boolean, Source extends MapContainer<Key, T, Unique, Source>> extends ReverseIterator<Entry<Key, T>, Source, MapIterator<Key, T, Unique, Source>, MapReverseIterator<Key, T, Unique, Source>> {
    /**
