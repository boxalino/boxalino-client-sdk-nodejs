 ...
 */
export declare class ArrayIterator<T, Source extends ArrayContainer<T, Source>> implements Iterator<T, Source, ArrayIterator<T, Source>, ArrayReverseIterator<T, Source>>, IRandomAccessIterator<T, ArrayIterator<T, Source>> {
    /**
     * @hidden
     */
    private source_;
 ...
 * @author Jeongho Nam <http://samchon.org>
 */
export declare class ArrayReverseIterator<T, Source extends ArrayContainer<T, Source>> extends ReverseIterator<T, Source, ArrayIterator<T, Source>, ArrayReverseIterator<T, Source>> implements IRandomAccessIterator<T, ArrayReverseIterator<T, Source>> {
    /**
     * Initializer Constructor.
     *
