 ...
 */
export declare abstract class ArrayContainer<T, SourceT extends ArrayContainer<T, SourceT>> extends Container<T, SourceT, ArrayIterator<T, SourceT>, ArrayReverseIterator<T, SourceT>> implements ILinearContainer<T, SourceT, ArrayIterator<T, SourceT>, ArrayReverseIterator<T, SourceT>> {
    /**
     * @inheritDoc
     */
     ...
     * @inheritDoc
     */
    insert<U extends T, InputIterator extends Readonly<IForwardIterator<U, InputIterator>>>(pos: ArrayIterator<T, SourceT>, first: InputIterator, last: InputIterator): ArrayIterator<T, SourceT>;
    /**
     * @hidden
     */
     ...
     * @hidden
     */
    protected abstract _Insert_by_range<U extends T, InputIterator extends Readonly<IForwardIterator<U, InputIterator>>>(pos: ArrayIterator<T, SourceT>, first: InputIterator, last: InputIterator): ArrayIterator<T, SourceT>;
    /**
     * @inheritDoc
     */
