 ...
 * @hidden
 */
export interface IHashMap<Key, T, Unique extends boolean, Source extends MapContainer<Key, T, Unique, Source>> extends MapContainer<Key, T, Unique, Source>, _IHashContainer<Key> {
    /**
     * @inheritDoc
     */
