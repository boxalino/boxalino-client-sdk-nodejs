...
function _Construct(Source, XTree) {
    var _this = this;
    var args = [];
    ...
    if (args.length === 1 && args[0] instanceof Source) {
        ...
        var tuple = _IAssociativeContainer_1._Fetch_arguments.bind(this).apply(void 0, __spread(args));
...
function _Emplace_hint(hint, elem, breaker) {
    var prev = hint.prev();
    var meet = prev.equals(this.end()) || this.value_comp()(prev.value, elem);
