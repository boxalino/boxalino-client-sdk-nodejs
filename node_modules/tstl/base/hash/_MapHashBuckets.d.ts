 ...
 * @hidden
 */
export declare class _MapHashBuckets<Key, T, Unique extends boolean, Source extends MapContainer<Key, T, Unique, Source>> extends _HashBuckets<MapIterator<Key, T, Unique, Source>> {
    private source_;
