...
var _MultiMapTree_1 = require("../base/tree/_MultiMapTree");
...
var TreeMultiMap = /** @class */ (function (_super) {
    ...
    function TreeMultiMap() {
        ...
        _ITreeContainer_1._Construct.bind(_this, TreeMultiMap, _MultiMapTree_1._MultiMapTree).apply(void 0, __spread(args));
        return _this;
    }
    /* ---------------------------------------------------------
        ASSIGN & CLEAR
    ...
    TreeMultiMap.prototype.emplace_hint = function (hint, key, val) {
        var _this = this;
        return _ITreeContainer_1._Emplace_hint.bind(this)(hint, new Entry_1.Entry(key, val), function () {
            return _this.emplace(key, val);
        });
    };
    /**
     * @hidden
