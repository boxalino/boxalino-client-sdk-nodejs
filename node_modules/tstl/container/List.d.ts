...
export declare class List<T> extends ListContainer<T, List<T>, List.Iterator<T>, List.ReverseIterator<T>> implements IDequeContainer<T, List<T>, List.Iterator<T>, List.ReverseIterator<T>>, _IListAlgorithm<T, List<T>> {
     ...
     * @inheritDoc
     */
    merge<U extends T>(source: List<U>, comp?: (x: T, y: T) => boolean): void;
    /**
     * Transfer elements.
     *
     ...
     */
    splice<U extends T>(pos: List.Iterator<T>, from: List<U>): void;
    /**
     ...
     */
    splice<U extends T>(pos: List.Iterator<T>, from: List<U>, it: List.Iterator<U>): void;
    /**
...
export declare namespace List {
     ...
     * @author Jeongho Nam <http://samchon.org>
     */
    class Iterator<T> extends ListIterator<T, List<T>, Iterator<T>, ReverseIterator<T>> {
        /**
         * @hidden
         */
        private source_ptr_;
     ...
     * @author Jeongho Nam <http://samchon.org>
     */
    class ReverseIterator<T> extends ReverseIteratorBase<T, List<T>, Iterator<T>, ReverseIterator<T>> {
