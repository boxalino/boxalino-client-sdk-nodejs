 ...
 */
export declare class ForwardList<T> implements IForwardContainer<T, ForwardList.Iterator<T>>, _IClear, _IEmpty, _ISize, _IDeque<T>, _IFront<T>, Iterable<T>, _IListAlgorithm<T, ForwardList<T>> {
    /**
     * @hidden
     */
    private ptr_;
