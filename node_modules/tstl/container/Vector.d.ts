 ...
 */
export declare class Vector<T> extends ArrayContainer<T, Vector<T>> {
    /**
     * @hidden
     */
    private data_;
     ...
     * @inheritDoc
     */
    assign<U extends T, InputIterator extends Readonly<IForwardIterator<U, InputIterator>>>(begin: InputIterator, end: InputIterator): void;
    /**
     * @inheritDoc
     */
    clear(): void;
     ...
     * @hidden
     */
    protected _Insert_by_range<U extends T, InputIterator extends Readonly<IForwardIterator<U, InputIterator>>>(position: Vector.Iterator<T>, first: InputIterator, last: InputIterator): Vector.Iterator<T>;
    /**
     * @inheritDoc
     */
    pop_back(): void;
