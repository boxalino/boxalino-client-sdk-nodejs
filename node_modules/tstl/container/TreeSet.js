...
var TreeSet = /** @class */ (function (_super) {
    ...
    function TreeSet() {
        ...
        _ITreeContainer_1._Construct.bind(_this, TreeSet, _UniqueSetTree_1._UniqueSetTree).apply(void 0, __spread(args));
        return _this;
    }
    /* ---------------------------------------------------------
        ASSIGN & CLEAR
    ...
    TreeSet.prototype._Insert_by_hint = function (hint, key) {
        var _this = this;
        return _ITreeContainer_1._Emplace_hint.bind(this)(hint, key, function () {
            return _this._Insert_by_key(key).first;
        });
    };
    /**
     * @hidden
