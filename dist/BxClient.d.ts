...
export declare class BxClient {
    ...
    setSocket(socketHost: string, socketPort?: number, socketSendTimeout?: number, socketRecvTimeout?: number): void;
    ...
    getChoiceIdRecommendationRequest(choiceId: string): null;
    ...
    getDebugOutput(): any;
    setDebugOutputActive(debugOutputActive: boolean): void;
